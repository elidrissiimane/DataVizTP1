...
## II - Exemples de ma propre exéprience

Pendant mes stages, j'utilise pas mal de diagrammes de flux. La figure ci-dessous représente un diagramme de flux lié à un stage dans le domaine de Web.
<table border="0">
  <tr>
    <td>
      <img src="img/MyDiag.png" "align:"center">
    </td>
  </tr>
</table>
Ce diagramme représente les différents scénarios que l'utilisateur pourrait effectuer en navigant sur la plateforme Web. En fait, en passant par la page d'accueil, l'utilisateur peut accéder au back-office, puis à une fonctionnalité "Revue d'activité". Ensuite, il peut créer un revue. Après la création, il peut modifier, supprimer ou intégrer un résultat. Le reste du diagramme décrit l'intéraction de l'utilisateur avec cette fonctionnalité: les différentes étapes à faire pour intégrer une nouvelle résultat pour un certain activité.
Ce diagramme permet aussi de spécifier le point d'arriver pour chaque scénario.

## III- Types de diagramme de flux

### III.1- Diagramme de flux détaillé
...
### III.2- Diagramme de flux de déploiement ou en matrice
...
## IV- Symboles de diagramme de flux
<table border="0">
  <tr>
    <td>
...
## V- Exemples de diagrammes de flus et commentaires

### V.1- diagramme de flux fonctionnel croisé
...
#### V.1.1- Analyse de diagramme de flux fonctionnel croisé
...
### V.2- Diagramme de flux de processus
...
#### V.2.1- Exemple d'un diagramme de flux de processus
...
### V.3- Diagramme de flux de données
...
#### V.3.1- Exemples de diagramme de flux de données
...
#### V.3.2- Historique pour ce diagramme
...
#### V.3.3- Exemple de création d'un diagramme de flux de données
